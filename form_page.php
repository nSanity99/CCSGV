...
<body>
    ...
    <div class="form-group" style="flex-basis: 100%;">
        <label for="product-search-input">
            Cerca un prodotto dal catalogo o scrivi un nome personalizzato, se non è presente:
        </label>
        <input
            type="text"
            id="product-search-input"
            name="product"
            placeholder="Es: Carta A4, Penna , Nastro Adesivo"
            autocomplete="off"
            aria-describedby="product-search-help"
        >
        <small id="product-search-help" class="form-text text-muted">
            Inizia a digitare per cercare nel catalogo. Se il prodotto non esiste, puoi scriverne uno nuovo.
        </small>
        <div id="product-search-results" role="listbox"></div>
    </div>
</div>

                    
                    <p style="text-align:center; margin: 20px 0; font-weight: 500; color:rgb(241, 7, 7);">-- OPPURE --</p>
